    ...
    <div className="flex flex-col md:flex-row justify-between items-stretch gap-4">
        ...
        <p className="text-base md:text-lg text-white/50 leading-relaxed italic">
          {isWhatIf ? (
            ...
            <>
              ...
              you yielded a <span className="text-[#37ffef] font-black not-italic text-xl md:text-2xl">{activeTransfer.pointsGained} point surplus</span>.
      ...
      <div className="grid grid-cols-2 gap-2 md:gap-3">
        ...
        <div className="bg-white/5 p-3 md:p-4 rounded-2xl border border-white/5 text-center flex flex-col justify-center min-w-[100px] md:min-w-[120px]">
          ...
          <p className={`text-xl md:text-2xl font-black ${(activeTransfer.netGainAfterHit ?? activeTransfer.pointsGained) >= 0 ? 'text-[#37ffef]' : 'text-[#ff6b9d]'}`}>
