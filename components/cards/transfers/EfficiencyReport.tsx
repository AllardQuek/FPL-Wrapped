  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-stretch gap-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="bg-white/5 p-4 rounded-[24px] border border-white/5 text-center flex flex-col justify-center min-w-[120px]">
          <p className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1">Net Gain</p>
        ...
        <div className="bg-white/5 p-4 rounded-[24px] border border-white/5 text-center flex flex-col justify-center min-w-[120px]">
          <p className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1">PPG Diff</p>
        ...
        <div className="bg-white/5 p-4 rounded-[24px] border border-white/5 text-center flex flex-col justify-center min-w-[120px]">
          <p className="text-[9px] font-black text-white/30 uppercase tracking-widest mb-1">Best Run</p>
