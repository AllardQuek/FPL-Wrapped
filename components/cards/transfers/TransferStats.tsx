...
export function TransferStats({ totalTransfers, netImpact, grade }: TransferStatsProps) {
  return (
    <div className="grid grid-cols-4 gap-3 mb-10 text-left">
      <div className="bg-white/5 rounded-2xl p-6 border border-white/5 text-center">
        <p className="text-[10px] font-bold text-white/40 tracking-widest uppercase mb-1">Volume</p>
        <p className="text-2xl font-black text-white">{totalTransfers}</p>
        <p className="text-[9px] font-bold text-white/20 uppercase">Transfers</p>
      </div>
      <div className="bg-white/5 rounded-2xl p-6 border border-white/5 text-center flex flex-col items-center">
        <div className="flex items-center gap-1 mb-1 justify-center">
          <p className="text-[10px] font-bold text-white/40 tracking-widest uppercase">Net Impact</p>
          <InfoTooltip 
        ...
        <p className="text-[9px] font-bold text-white/20 uppercase">Points Added</p>
      </div>
      <div className="bg-white/5 rounded-2xl p-6 border border-white/5 text-center flex flex-col items-center">
        <div className="flex items-center gap-1 mb-1 justify-center">
          <p className="text-[10px] font-bold text-white/40 tracking-widest uppercase">Avg. Impact</p>
          <InfoTooltip 
            maxWidth="max-w-[280px]"
            content={
              <div className="space-y-2">
        ...
        <p className="text-[9px] font-bold text-white/20 uppercase">Pts / Transfer</p>
      </div>
      <div className="bg-white/5 rounded-2xl p-6 border border-white/5 text-center">
        <p className="text-[10px] font-bold text-white/40 tracking-widest uppercase mb-1">Efficiency</p>
        <p className="text-2xl font-black text-white">{grade || '-'}</p>
        <p className="text-[9px] font-bold text-white/20 uppercase">Grade</p>
      </div>
    </div>
  );
}
