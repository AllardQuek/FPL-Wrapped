        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="mt-4 lg:mt-0 space-y-3 flex flex-col">
            ...
            <motion.div
              ...
              className="flex-1"
            >
              <div className="group w-full flex flex-col items-center justify-center gap-6 px-6 py-10 md:px-10 md:py-10 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-[#00ff87]/30 hover:bg-[#00ff87]/5 transition-all duration-500 relative overflow-hidden h-full min-h-[200px] shadow-2xl shadow-black/50">
