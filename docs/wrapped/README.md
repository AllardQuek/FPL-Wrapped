...
- **[Manager Personas Reference](docs/wrapped/engine/manager-personas.md)** - Complete guide to all 16 manager personas with quick reference table, scoring weights, and UX integration
- **[Design Decisions & Technical Architecture](docs/wrapped/architecture/design-decisions.md)** - Deep dive into caching, persona logic, and methodology
- **[Next.js vs Vite Discussion](docs/wrapped/architecture/nextjs-vite.md)** - Architectural reasoning for choosing Next.js
