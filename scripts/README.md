...
Long-form script documentation has been moved to `docs/wrapped/scripts/`:
- `docs/wrapped/scripts/STANDARDIZATION_GUIDE.md`
- `docs/wrapped/scripts/IMAGE_AUDIT_REPORT.md`
